...
import {
  ...
  SimpleGetTokenPriceIDParams,
  SimpleGetTokenPriceIDResponse,
} from './resources/simple';
import { readEnv } from './internal/utils/env';
import { formatRequestDetails, loggerFor } from './internal/utils/log';
import { isEmptyObj } from './internal/utils/values';
import {
  CoinGetCategoriesParams,
  CoinGetCategoriesResponse,
  CoinGetIDParams,
  CoinGetIDResponse,
  CoinGetListParams,
  CoinGetListResponse,
...
export interface ClientOptions {
  /**
   * Defaults to process.env['COINGECKO_PRO_API_KEY'].
   */
  proAPIKey?: string | null | undefined;

  /**
   * Defaults to process.env['COINGECKO_DEMO_API_KEY'].
   */
...
export declare namespace Coingecko {
  ...
  export {
    ...
    type SimpleGetTokenPriceIDResponse as SimpleGetTokenPriceIDResponse,
    type SimpleGetPriceParams as SimpleGetPriceParams,
    type SimpleGetTokenPriceIDParams as SimpleGetTokenPriceIDParams,
  };
