...
export class Coins extends APIResource {
   ...
   * @example
   * ```ts
   * const response = await client.coins.getCategories();
   * ```
   */
  getCategories(
    query: CoinGetCategoriesParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<CoinGetCategoriesResponse> {
   ...
   * @example
   * ```ts
   * const response = await client.coins.getList();
   * ```
   */
  getList(
    query: CoinGetListParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<CoinGetListResponse> {
    return this._client.get('/coins/list', { query, ...options });
  }
}

export interface CoinGetCategoriesResponse {
  /**
   * category ID
   */
  id?: string;
...
export type CoinGetListResponse = Array<CoinGetListResponse.CoinGetListResponseItem>;

export namespace CoinGetListResponse {
  export interface CoinGetListResponseItem {
    /**
     * coin ID
     */
    id?: string;
...
export interface CoinGetCategoriesParams {
  /**
...
export interface CoinGetListParams {
  /**
...
export declare namespace Coins {
  export {
    type CoinGetCategoriesResponse as CoinGetCategoriesResponse,
    type CoinGetIDResponse as CoinGetIDResponse,
    type CoinGetListResponse as CoinGetListResponse,
    type CoinGetCategoriesParams as CoinGetCategoriesParams,
    type CoinGetIDParams as CoinGetIDParams,
    type CoinGetListParams as CoinGetListParams,
  };
