...
export class Pools extends APIResource {
  ...
  ): APIPromise<PoolGetMegafilterResponse> {
    return this._client.get('/onchain/pools/megafilter', { query, ...options });
  }
}

export interface PoolGetMegafilterResponse {
  data?: Array<PoolGetMegafilterResponse.Data>;

  included?: Array<PoolGetMegafilterResponse.Included>;
}

export namespace PoolGetMegafilterResponse {
