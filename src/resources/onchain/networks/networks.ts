...
import {
  PoolGetMultiAddressesParams,
  PoolGetMultiAddressesResponse,
  PoolGetParams,
  PoolGetResponse,
  Pools,
} from './pools';
import * as TokensAPI from './tokens';
import { TokenGetMultiAddressesParams, TokenGetMultiAddressesResponse, Tokens } from './tokens';
...
export class Networks extends APIResource {
   ...
   * ```ts
   * const response =
   *   await client.onchain.networks.getTrendingPools('eth');
   * ```
   */
  getTrendingPools(
    network: string,
    ...
    options?: RequestOptions,
  ): APIPromise<NetworkGetTrendingPoolsResponse> {
...
export interface NetworkGetTrendingPoolsResponse {
  data?: Array<NetworkGetTrendingPoolsResponse.Data>;

  included?: Array<NetworkGetTrendingPoolsResponse.Included>;
}

export namespace NetworkGetTrendingPoolsResponse {
  export interface Data {
    id?: string;
...
export declare namespace Networks {
  ...
  export {
    ...
    type PoolGetMultiAddressesResponse as PoolGetMultiAddressesResponse,
    type PoolGetParams as PoolGetParams,
    type PoolGetMultiAddressesParams as PoolGetMultiAddressesParams,
  };

  export {
    Tokens as Tokens,
    type TokenGetMultiAddressesResponse as TokenGetMultiAddressesResponse,
    type TokenGetMultiAddressesParams as TokenGetMultiAddressesParams,
  };
}
