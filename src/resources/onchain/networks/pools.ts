...
export class Pools extends APIResource {
   ...
   * ```ts
   * const response =
   *   await client.onchain.networks.pools.getMultiAddresses(
   *     'addresses',
   *     { network: 'eth' },
   *   );
   * ```
  ...
  getMultiAddresses(
    addresses: string,
    params: PoolGetMultiAddressesParams,
    options?: RequestOptions,
  ): APIPromise<PoolGetMultiAddressesResponse> {
...
export interface PoolGetMultiAddressesResponse {
  data?: Array<PoolGetMultiAddressesResponse.Data>;

  included?: Array<PoolGetMultiAddressesResponse.Included>;
}

export namespace PoolGetMultiAddressesResponse {
  export interface Data {
    id?: string;
...
export interface PoolGetMultiAddressesParams {
  /**
