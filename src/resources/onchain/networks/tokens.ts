...
export class Tokens extends APIResource {
   ...
   * ```ts
   * const response =
   *   await client.onchain.networks.tokens.getMultiAddresses(
   *     'addresses',
   *     { network: 'eth' },
   *   );
   * ```
  ...
  getMultiAddresses(
    addresses: string,
    params: TokenGetMultiAddressesParams,
    options?: RequestOptions,
  ): APIPromise<TokenGetMultiAddressesResponse> {
...
export interface TokenGetMultiAddressesResponse {
  data?: TokenGetMultiAddressesResponse.Data;

  included?: Array<TokenGetMultiAddressesResponse.Included>;
}

export namespace TokenGetMultiAddressesResponse {
...
export interface TokenGetMultiAddressesParams {
  /**
