...
export class Networks extends APIResource {
   ...
   * ```ts
   * const response =
   *   await client.onchain.simple.networks.getTokenPriceAddresses(
   *     'addresses',
   *     { network: 'eth' },
   *   );
   * ```
   */
  getTokenPriceAddresses(
    addresses: string,
    params: NetworkGetTokenPriceAddressesParams,
    options?: RequestOptions,
  ): APIPromise<NetworkGetTokenPriceAddressesResponse> {
...
export interface NetworkGetTokenPriceAddressesResponse {
  data?: NetworkGetTokenPriceAddressesResponse.Data;
}

export namespace NetworkGetTokenPriceAddressesResponse {
...
export interface NetworkGetTokenPriceAddressesParams {
  /**
