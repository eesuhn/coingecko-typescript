...
export class Simple extends APIResource {
   ...
   * @example
   * ```ts
   * const response = await client.simple.getTokenPriceID(
   *   'ethereum',
   *   {
  ...
  getTokenPriceID(
    id: string,
    query: SimpleGetTokenPriceIDParams,
    options?: RequestOptions,
  ): APIPromise<SimpleGetTokenPriceIDResponse> {
...
export interface SimpleGetTokenPriceIDResponse {
  /**
   * last updated timestamp
   */
  last_updated_at?: number;
...
export interface SimpleGetTokenPriceIDParams {
  /**
