...
describe('resource simple', () => {
  ...
  // skipped: tests are disabled for the time being
  test.skip('getTokenPriceID: only required params', async () => {
    const responsePromise = client.simple.getTokenPriceID('ethereum', {
  ...
  // skipped: tests are disabled for the time being
  test.skip('getTokenPriceID: required and optional params', async () => {
    const response = await client.simple.getTokenPriceID('ethereum', {
      contract_addresses: 'contract_addresses',
      vs_currencies: 'vs_currencies',
      include_24hr_change: true,
      include_24hr_vol: true,
